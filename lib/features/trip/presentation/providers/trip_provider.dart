...
import 'package:travel_app_riverpod/features/trip/domain/usecases/add_trip.dart';
import 'package:travel_app_riverpod/features/trip/domain/usecases/delete_trip.dart';
...
class TripListNotifier extends StateNotifier<List<Trip>> {
  ...
  Future<void> addNewTrip(Trip trip) async {
    await _addTrip(trip: trip);
  }

  Future<void> removeTrip(int tripId) async {
    _deleteTrip(index: tripId);
  }
